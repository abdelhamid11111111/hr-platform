...
interface rvwPropsUpdate {
  updateReview: (id: number, newRvw: Review) => void
  reviewId: number
}

const EditReviewForm = ({reviewId, updateReview}: rvwPropsUpdate) => {
  ...
  return (
    <div>
      ...
      <button
        ...
        className="inline-flex cursor-pointer text-sm items-center px-3 py-1.5 font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 hover:border-blue-300 outline-none transition-all duration-150 gap-1"
      >
        <LiaEdit size={20} />
        Edit
      </button>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Edit your feedback for an employee
              </p>
            </div>
